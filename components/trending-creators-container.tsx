...
import styles from "./trending-creators-container.module.css";

const TrendingCreatorsContainer: NextPage = () => {
  return (
      ...
      <div className={styles.creatorsheader}>
        <div className={styles.trendingCreatorsParent}>
          ...
          <div className={styles.frameParent}>
            <img className={styles.frameChild} alt="" src="/frame-343433.svg" />
            <img className={styles.frameChild} alt="" src="/frame-343443.svg" />
          </div>
        </div>
      </div>
